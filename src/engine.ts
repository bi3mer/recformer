...
import { KEY_GAME, KEY_MAIN_MENU, KEY_PLAYER_BEAT_THE_GAME, KEY_PLAYER_LOST, KEY_PLAYER_WON, KEY_TRANSITION } from "./sceneKeys";
...
export class Engine {
  ...
  constructor() {
    ...
    this.sceneManager.registerScene(KEY_MAIN_MENU, new MainMenuScene(this.ctx, transitionScene));
    this.sceneManager.registerScene(KEY_GAME, new GameScene(this.ctx, transitionScene));
    ...
    this.sceneManager.registerScene(KEY_PLAYER_WON, new PlayerBeatLevelScene(this.ctx, transitionScene));
    this.sceneManager.registerScene(KEY_PLAYER_LOST, new PlayerLostLevelScene(this.ctx, transitionScene));
